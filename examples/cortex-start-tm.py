...
cortex_start_command = openapi_client.CortexCommand(command=command_start, args=arguments)
...
try:
    print('Sending command {} with arguments {}'.format(command_start, arguments))
    cortex_command_inst.post_cortex_command(cortex_command=cortex_start_command,
                                            authentication=auth)
